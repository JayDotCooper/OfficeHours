...
sem_t sem_seat1, sem_seat2, sem_seat3;
sem_t sem_classA, sem_classB;
sem_t sem_officeSeats;
...
static int initialize(student_info *si, char *filename) 
{
  ...
  sem_init(&sem_classA, 0, 1) // Class A will go first
  sem_init(&sem_classB, 0, 0)
  // sem_init(&sem_seat1, 0, 1)
  // sem_init(&sem_seat2, 0, 1)
  // sem_init(&sem_seat3, 0, 1)
  sem_init(&sem_officeSeats, 0, 3)
